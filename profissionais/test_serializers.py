...
from profissionais.serializers import (
    EnderecoSerializer, ProfissionalSerializer, ProfissionalListSerializer,
...
class TestProfissionalSerializerVariants(TestCase):
    ...
    def test_profissional_list_serializer(self):
        ...
        campos_esperados = ['id', 'nome_social', 'profissao', 'especialidade', 
                           'email', 'telefone', 'aceita_convenio', 'valor_consulta']
    ...
    def test_profissional_detail_serializer(self):
        ...
        campos_esperados = ['id', 'nome_social', 'nome_completo', 'profissao', 
                           'endereco', 'biografia', 'created_at', 'updated_at']
