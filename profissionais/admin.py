...
class EnderecoAdmin(admin.ModelAdmin):
    ...
    fieldsets = (
        ("Endereço", {"fields": ("logradouro", "numero", "complemento", "bairro")}),
        ("Localização", {"fields": ("cidade", "estado", "cep", "referencia")}),
        ("Status", {"fields": ("is_active",)}),
        (
            "Informações do Sistema",
            {"fields": ("id", "created_at", "updated_at", "endereco_completo"), "classes": ("collapse",)},
        ),
    )
...
class ProfissionalAdmin(admin.ModelAdmin):
    ...
    list_display = ("nome_social", "profissao", "email", "telefone", "cidade_atendimento", "aceita_convenio", "is_active")
    list_filter = ("profissao", "aceita_convenio", "endereco__cidade", "endereco__estado", "is_active", "created_at")
    search_fields = ("nome_social", "nome_registro", "email", "telefone", "registro_profissional", "especialidade")
    readonly_fields = ("id", "created_at", "updated_at", "nome_completo", "get_contato_formatado")

    fieldsets = (
        ("Informações Pessoais", {"fields": ("nome_social", "nome_registro")}),
        ("Informações Profissionais", {"fields": ("profissao", "registro_profissional", "especialidade", "biografia")}),
        ("Contato", {"fields": ("email", "telefone", "whatsapp")}),
        ("Endereço", {"fields": ("endereco",)}),
        ("Serviços", {"fields": ("aceita_convenio", "valor_consulta")}),
        ("Status", {"fields": ("is_active",)}),
        (
            "Informações do Sistema",
            {"fields": ("id", "created_at", "updated_at", "nome_completo", "get_contato_formatado"), "classes": ("collapse",)},
        ),
    )
