...
class TestRateLimitingAndSecurity(TestCase):
    ...
    def test_rapid_requests(self):
        ...
        self.assertTrue(
            all(status_code == status.HTTP_200_OK for status_code in responses) or
    ...
    def test_brute_force_login_attempts(self):
        ...
        self.assertTrue(
            all(status_code == status.HTTP_401_UNAUTHORIZED for status_code in responses) or
            status.HTTP_429_TOO_MANY_REQUESTS in responses
        )
