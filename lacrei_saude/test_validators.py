...
from lacrei_saude.validators import (
    sanitize_string, validate_cpf, validate_phone, validate_cep,
    validate_crm, validate_password_strength, sanitize_email,
    validate_money_amount, sanitize_html_content, validate_name,
...
class TestValidateObservation(TestCase):
    ...
    def test_observacao_valida(self):
        ...
        """
        observacoes_validas = [
            'Paciente relatou dor de cabeça',
