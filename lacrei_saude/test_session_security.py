...
class JWTSecurityTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="jwttest", email="jwt@test.com", password="TestPassword123!", user_type="paciente"
        )
        cache.clear()

    def test_jwt_token_generation(self):
        """Testa geração segura de tokens JWT"""
        response = self.client.post(reverse("authentication:login"), {"username": "jwttest", "password": "TestPassword123!"})
    ...
    def test_token_reuse_prevention(self):
        ...
        if response.status_code == 200:
            ...
            if logout_response.status_code in [200, 204]:
                ...
                if hasattr(settings, "SIMPLE_JWT") and getattr(settings.SIMPLE_JWT, "BLACKLIST_AFTER_ROTATION", False):
...
class SessionManagementTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="sessiontest", email="session@test.com", password="TestPassword123!", user_type="paciente"
        )
        cache.clear()
    ...
    def test_concurrent_session_management(self):
        ...
        response1 = self.client.post(
            reverse("authentication:login"), {"username": "sessiontest", "password": "TestPassword123!"}
        )
        ...
        client2 = APIClient()
        response2 = client2.post(reverse("authentication:login"), {"username": "sessiontest", "password": "TestPassword123!"})
    ...
    def test_remember_me_functionality(self):
        ...
        remember_login = self.client.post(
            reverse("authentication:login"), {"username": "sessiontest", "password": "TestPassword123!", "remember": True}
        )
...
class SessionFixationTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="fixationtest", email="fixation@test.com", password="TestPassword123!", user_type="paciente"
        )
    ...
    def test_session_id_regeneration(self):
        ...
        response1 = self.client.post(
            reverse("authentication:login"), {"username": "fixationtest", "password": "TestPassword123!"}
        )
...
class TokenRefreshSecurityTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="refreshtest", email="refresh@test.com", password="TestPassword123!", user_type="paciente"
        )

    def test_refresh_token_security(self):
        """Testa segurança do refresh token"""
        response = self.client.post(
            reverse("authentication:login"), {"username": "refreshtest", "password": "TestPassword123!"}
        )
    ...
    def test_refresh_token_rotation(self):
        ...
        if login_response.status_code == 200:
            ...
            # Usa refresh token
            refresh_response = self.client.post(reverse("authentication:token_refresh"), {"refresh": refresh_token})
            ...
            if refresh_response.status_code == 200:
                ...
                if new_refresh_token:
                    ...
                    old_refresh_response = self.client.post(
                        reverse("authentication:token_refresh"), {"refresh": refresh_token}
                    )
...
class CSRFProtectionTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="csrftest", email="csrf@test.com", password="TestPassword123!", user_type="paciente"
        )
    ...
    def test_state_changing_operations(self):
        ...
        response = self.client.post(reverse("authentication:login"), {"username": "csrftest", "password": "TestPassword123!"})
...
class SessionHijackingProtectionTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="hijacktest", email="hijack@test.com", password="TestPassword123!", user_type="paciente"
        )
    ...
    def test_user_agent_binding(self):
        ...
        response = self.client.post(
            ...
            {"username": "hijacktest", "password": "TestPassword123!"},
        ...
        if response.status_code == 200:
            ...
            different_ua_response = self.client.get("/api/auth/status/", HTTP_USER_AGENT="DifferentAgent/2.0")
    ...
    def test_ip_address_binding(self):
        ...
        if response.status_code == 200:
            ...
            different_ip_response = self.client.get("/api/auth/status/", HTTP_X_FORWARDED_FOR="192.168.1.200")
    ...
    def test_session_fingerprinting(self):
        ...
        response = self.client.post(
            reverse("authentication:login"), {"username": "hijacktest", "password": "TestPassword123!"}, **headers
        )
        ...
        if response.status_code == 200:
            ...
            hijack_response = self.client.get("/api/auth/status/", **different_headers)
...
class SessionSecurityIntegrationTestCase(APITestCase):
    ...
    def setUp(self):
        ...
        self.user = User.objects.create_user(
            username="integration", email="integration@test.com", password="TestPassword123!", user_type="profissional"
        )
        cache.clear()
    ...
    def test_complete_session_lifecycle(self):
        ...
        # 1. Login
        login_response = self.client.post(
            reverse("authentication:login"), {"username": "integration", "password": "TestPassword123!"}
        )
