...
class TestSQLInjection(TestCase):
    ...
    def test_sql_injection_em_email(self):
        ...
        for payload in sql_injection_payloads:
            ...
            self.assertFalse(Profissional.objects.filter(email="hacked@test.com").exists())
    ...
    def test_sql_injection_em_busca_texto(self):
        ...
        endereco = Endereco.objects.create(
            logradouro="Rua Busca", numero="100", bairro="Busca", cidade="São Paulo", estado="SP", cep="12345678"
        )

        profissional = Profissional.objects.create(
            nome_social="Dr. Busca", profissao="MEDICO", email="busca@test.com", telefone="11987654321", endereco=endereco
        )
    ...
    def test_sql_injection_secondorder(self):
        ...
        if response.status_code == status.HTTP_201_CREATED:
            ...
            detail_url = reverse("profissionais:profissional-detail", kwargs={"pk": profissional_id})
            ...
            update_response = self.client.patch(detail_url, {"especialidade": "Cardiologia"}, format="json")
...
class TestNoSQLInjection(TestCase):
    ...
    def test_mongodb_injection_operators(self):
        ...
        for payload in mongodb_payloads:
            ...
            test_cases = [{"email": payload}, {"profissao": payload}, {"filters": payload}]
            ...
            for test_case in test_cases:
                ...
                self.assertIn(
                    ...
                    [status.HTTP_200_OK, status.HTTP_400_BAD_REQUEST],  # Filtro ignorado  # Erro de validação
                )
...
class TestCommandInjection(TestCase):
    ...
    def test_command_injection_em_processamento_dados(self):
        ...
        for payload in command_payloads:
            test_cases = [{"nome_social": payload}, {"especialidade": payload}, {"biografia": payload}]
    ...
    def test_ldap_injection(self):
        ...
        for payload in ldap_payloads:
            credentials = {"username": payload, "password": "anypassword"}
    ...
    def test_xpath_injection(self):
        ...
        for payload in xpath_payloads:
            ...
            self.assertIn(
                response.status_code,
                [status.HTTP_201_CREATED, status.HTTP_400_BAD_REQUEST],  # Entrada sanitizada  # Entrada rejeitada
            )
