...
class A04InsecureDesignTestCase(APITestCase):
    ...
    def test_business_logic_bypass(self):
        ...
        response = self.client.post('/api/v1/consultas/', {
            'profissional': 1,
            'data_horario': past_date,
            'observacoes': 'Teste'
        })
...
class A08SoftwareDataIntegrityFailuresTestCase(APITestCase):
    ...
    def test_data_tampering_protection(self):
        ...
        # Cria dados
        response = self.client.post('/api/v1/profissionais/', {
            'nome': 'Dr. Teste',
        ...
        if response.status_code in [200, 201]:
            ...
            tamper_response = self.client.patch(f'/api/v1/profissionais/{profissional_id}/', {
                'crm': 'INVALID_CRM'
            })
    ...
    def test_authentication_logging(self):
        ...
        with self.assertLogs(level='INFO') as log:
            ...
            auth_logged = any(
                ...
                for keyword in ['login', 'auth', 'authentication', 'failed']
            )
    ...
    def test_access_control_logging(self):
        ...
        with self.assertLogs(level='WARNING') as log:
            ...
            if response.status_code == 403:
                ...
                access_logged = any(
                    keyword in log_output.lower()
                    for keyword in ['access', 'forbidden', 'denied', '403']
                )
...
class A10ServerSideRequestForgeryTestCase(APITestCase):
        ...
        for url in malicious_urls:
            ...
            for endpoint in endpoints:
                ...
                if response.status_code in [200, 201]:
                    ...
                    ssrf_indicators = [
                        'SSH-', 'mysql_native_password', 'ami-id',
                        'root:', 'admin:', 'password:'
                    ]
    ...
    def test_ip_address_filtering(self):
        ...
        for ip in blocked_ips:
            ...
            test_response = self.client.post('/api/test/', {
                'external_url': malicious_url
            })
    ...
    def test_ssrf_with_redirects(self, mock_requests):
        ...
        response = self.client.post('/api/external/', {
            'url': external_url
        })
