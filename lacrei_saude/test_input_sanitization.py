    ...
    def test_context_aware_encoding(self):
        ...
        for data in contextual_data:
            response = self.client.post('/api/v1/consultas/', {
                ...
                'data_horario': '2025-12-31T10:00:00Z',
                'observacoes': data
            })
...
class SQLInjectionPreventionTestCase(APITestCase):
    ...
    def test_filter_parameter_injection(self):
        ...
        filter_payloads = [
            "1' OR '1'='1",
            "1; DROP TABLE profissionais_profissional; --",
    ...
    def test_system_command_injection(self):
        ...
        for payload in command_payloads:
            ...
            test_data = {
                ...
                'path': f'/uploads/{payload}',
                'command': f'process {payload}'
            }
