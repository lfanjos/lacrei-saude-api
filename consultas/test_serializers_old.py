...
class TestConsultaSerializer(TestCase):
    ...
    def test_validacao_horario_comercial(self):
        ...
        data_fora_horario = timezone.now().replace(
...
class TestConsultaSerializerVariants(TestCase):
    ...
    def test_consulta_paciente_serializer(self):
        ...
        campos_esperados = ['id', 'profissional_nome', 'profissional_profissao', 
                           'data_hora', 'status', 'valor_consulta']
    ...
    def test_consulta_update_serializer(self):
        ...
        dados_update = {
            'observacoes': 'Consulta confirmada e atualizada',
            'status': 'EM_ANDAMENTO'
        }
        
        serializer = ConsultaUpdateSerializer(
            self.consulta, 
            data=dados_update, 
            partial=True
        )
...
class TestConsultaValidacoes(TestCase):
    ...
    def test_validacao_conflito_horario(self):
        ...
        if not serializer.is_valid():
            self.assertTrue(
                'data_consulta' in serializer.errors or
