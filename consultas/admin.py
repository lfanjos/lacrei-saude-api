...
class ConsultaAdmin(admin.ModelAdmin):
    ...
    list_filter = (
        "status",
        "tipo_consulta",
        "profissional__profissao",
        "profissional__endereco__cidade",
        "pago",
        "forma_pagamento",
        "is_active",
        "data_hora",
    ...
    fieldsets = (
        ("Informações da Consulta", {"fields": ("profissional", "data_hora", "duracao_estimada", "tipo_consulta")}),
        ("Paciente", {"fields": ("nome_paciente", "telefone_paciente", "email_paciente")}),
        ("Detalhes", {"fields": ("motivo_consulta", "observacoes", "observacoes_internas")}),
        ("Status e Controle", {"fields": ("status", "data_hora_fim")}),
        ("Financeiro", {"fields": ("valor_consulta", "forma_pagamento", "pago")}),
        (
            "Cancelamento/Remarcação",
            {
                "fields": ("motivo_cancelamento", "cancelado_por", "data_cancelamento", "consulta_origem"),
                "classes": ("collapse",),
            },
        ),
        ("Status do Sistema", {"fields": ("is_active",)}),
        (
    ...
    def get_queryset(self, request):
        """Optimize queries"""
        return super().get_queryset(request).select_related("profissional", "profissional__endereco", "consulta_origem")
